  ...
  "node_modules/openai/core/streaming.js"(exports2) {
    ...
    var Stream = class _Stream {
      constructor(iterator, controller, client2) {
        ...
        tslib_1.__classPrivateFieldSet(this, _Stream_client, client2, "f");
      }
      static fromSSEResponse(response, controller, client2) {
        let consumed = false;
        const logger = client2 ? (0, log_1.loggerFor)(client2) : console;
    ...
    async function defaultParseResponse(client2, props) {
      ...
      const body = await (async () => {
        if (props.options.stream) {
          (0, log_1.loggerFor)(client2).debug("response", response.status, response.url, response.headers, response.body);
          if (props.options.__streamClass) {
            return props.options.__streamClass.fromSSEResponse(response, props.controller, client2);
          }
          return streaming_1.Stream.fromSSEResponse(response, props.controller, client2);
        }
      ...
      (0, log_1.loggerFor)(client2).debug(`[${requestLogID}] response parsed`, (0, log_1.formatRequestDetails)({
        retryOfRequestLogID,
        url: response.url,
...
var require_api_promise = __commonJS({
  "node_modules/openai/core/api-promise.js"(exports2) {
    ...
    var APIPromise = class _APIPromise extends Promise {
      constructor(client2, responsePromise, parseResponse = parse_1.defaultParseResponse) {
        super((resolve) => {
          resolve(null);
        });
        ...
        tslib_1.__classPrivateFieldSet(this, _APIPromise_client, client2, "f");
      }
      _thenUnwrap(transform) {
        return new _APIPromise(tslib_1.__classPrivateFieldGet(this, _APIPromise_client, "f"), this.responsePromise, async (client2, props) => (0, parse_1.addRequestID)(transform(await this.parseResponse(client2, props), props), props.response));
      }
      /**
  ...
  "node_modules/openai/core/pagination.js"(exports2) {
    ...
    var AbstractPage = class {
      constructor(client2, response, body, options) {
        ...
        tslib_1.__classPrivateFieldSet(this, _AbstractPage_client, client2, "f");
    ...
    var PagePromise = class extends api_promise_1.APIPromise {
      constructor(client2, request, Page2) {
        super(client2, request, async (client3, props) => new Page2(client3, props.response, await (0, parse_1.defaultParseResponse)(client3, props), props.options));
      }
      /**
...
var require_client = __commonJS({
  "node_modules/openai/client.js"(exports2) {
    ...
    _a = OpenAI2, _OpenAI_encoder = /* @__PURE__ */ new WeakMap(), _OpenAI_instances = /* @__PURE__ */ new WeakSet(), _OpenAI_baseURLOverridden = function _OpenAI_baseURLOverridden2() {
    ...
    OpenAI2.InvalidWebhookSignatureError = Errors.InvalidWebhookSignatureError;
    ...
    OpenAI2.Webhooks = webhooks_1.Webhooks;
    ...
    OpenAI2.Conversations = conversations_1.Conversations;
...
// netlify/functions/ai-size.js
var OpenAI = require_openai();
var client = new OpenAI({ apiKey: process.env.OPENAI_API_KEY });
var allowedDefault = ["XS", "S", "M", "L", "XL", "XXL"];
var toEnum = (s) => String(s || "").toUpperCase().replace(/\s+/g, "");
var isBrandLikelyValid = (s = "") => {
  const t = s.trim();
...
//# sourceMappingURL=ai-size.js.map
